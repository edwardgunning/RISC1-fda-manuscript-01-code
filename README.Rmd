...
* :open_file_folder: **code**
  ...
  * :open_file_folder: **functions** -- custom functions used to perform the data analysis and simulation
    ...
    * :page_facing_up: [Function to calculate Monte Carlo Standard Errors for Coverage](code/functions/binomial_se.R)
    * :page_facing_up: [Tests Monte Carlo Standard Errors for Coverage](code/functions/binomial_se_tests.R)
