...
mfamm_results <- readRDS(here::here("outputs/results/mfamm-comparison-bootstrap.rds"))
...
combined_plot   
tikz(file.path(plots_path, "mfamm-comparison-bootstrap.tex"),
...
tinytex::lualatex(file.path(plots_path, "mfamm-comparison-bootstrap.tex"))
