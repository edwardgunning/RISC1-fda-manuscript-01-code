% Created by tikzDevice version 0.12.3.1 on 2023-02-27 15:19:05
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.90] at (438.64, 34.83) {Normalized Time ($\%$ of Stride)};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (569.05,189.68);
\definecolor{drawColor}{RGB}{0,0,0}
